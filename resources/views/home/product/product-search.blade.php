        ...
        <div class="product-grid4">
            <div class="product-image4">
                ...
                <ul class="social">
                        ...
                        <li><a data-tip="Thêm vào giỏ hàng" data-product_id="{{$p_search->product_id}}" class="cart"><i class="fa fa-shopping-cart"></i></a></li>
                </ul>
            ...
            <div class="product-content">
                <h3 class="title"><a href="#">{{$p_search->product_name}}</a></h3>
                <div class="price">
                    {{number_format($p_search->promo_price)}}<sup>đ</sup>
                    <span>{{number_format($p_search->unit_price)}}<sup>đ</sup></span>
                </div>
                <a class="add-to-cart cart" data-product_id="{{$p_search->product_id}}">Thêm vào giỏ hàng</a>
            </div>
        </div>
    </div>
    @endforeach
