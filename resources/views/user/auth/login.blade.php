                            ...
                            {{-- <div class="form-group row"> --}}
                                <div class="col-auto">
                                    ...
                                    <div class="input-group mb-2">
                                      ...
                                      <input id="email" type="email" class="form-control"  placeholder="Username" @error('email') is-invalid @enderror name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                      @error('email')
